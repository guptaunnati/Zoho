...
def build_rfft(c):
    ...
    invoke.run(
        "g++ -O3 -Wall -Werror -shared -std=c++11 -fPIC rfft.cpp -I/home/unnati-pt6974/pt6974_unnati/source/onnxruntime-linux-x64-1.14.1/include -L/home/unnati-pt6974/pt6974_unnati/source/onnxruntime-linux-x64-1.14.1/lib -lsndfile -lonnxruntime "
        "-o librfft.so "
    )
    print("* Complete")
...
def build_pybind11(c):
    ...
    compile_python_module("wrapper.cpp", "cal_rfft")
    print("* Complete")
